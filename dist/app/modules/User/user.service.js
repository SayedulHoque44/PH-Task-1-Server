...
const registerUserIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existingPhone = yield user_model_1.userModel.findOne({
        phone: payload.phone,
    });
    if (existingPhone) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, `${existingPhone.phone} is already exits!`);
    }
