...
const getArgumentsQueryFromDb = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const argumentsQuery = new QueryBuilder_1.default(arguments_model_1.ArgumentsModel.find(), query)
        ...
        .paginate()
        .fields();
    const result = yield argumentsQuery.modelQuery.populate("image");
...
const deleteArgumentFromDB = (argId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // delete argument
        const deletedArgument = yield arguments_model_1.ArgumentsModel.findByIdAndDelete(argId, {
            session,
        });
        if (!deletedArgument) {
        ...
        const deleteArgTopics = yield argTopics_model_1.ArgTopicsModel.deleteMany({
            argumentId: argId,
        }, { session });
        if (!deleteArgTopics) {
            throw new AppError_1.default(http_status_1.default.NOT_FOUND, "Faild to delete!");
        ...
        const deleteTopicQuizzes = yield topicQuizzes_model_1.TopicQuizModel.deleteMany({
            argumentId: argId,
        }, { session });
